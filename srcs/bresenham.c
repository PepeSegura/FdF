...
/*   Updated: 2024/03/08 19:17:32 by psegura-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	bresenham_line(t_fdf *fdf, t_point prev, t_point new)
{
	...
	if ((new.x < 0 && prev.x < 0) || (new.y < 0 && prev.y < 0)
		|| (new.x > fdf->screen_width && prev.x > fdf->screen_width)
		|| (new.y > fdf->screen_height && prev.y > fdf->screen_height))
		return ;
